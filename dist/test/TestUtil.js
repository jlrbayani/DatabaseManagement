...
exports.clearDisk = exports.persistDir = exports.getContentFromArchivesRaw = exports.getContentFromArchives = void 0;
...
function getContentFromArchivesRaw(name) {
    console.log(name);
    return fs.readFileSync(`test/resources/archives/${name}`);
}
exports.getContentFromArchivesRaw = getContentFromArchivesRaw;
function clearDisk() {
